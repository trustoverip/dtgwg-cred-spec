...
This repo is the home for the Decentralized Trust Graph (DTG) Credentials Core Specification v1.0, a deliverable of the [DTG Credentials Task Force repo](https://github.com/trustoverip/dtgwg-cred-tf).

Following the LF Joint Development Foundation (JDF) process, the repo will host a series of **Working Drafts**, numbered sequentially using [semver](https://semver.org), until the Task Force is ready to submit the specification for a vote as a **Working Group Approved Deliverable**.
